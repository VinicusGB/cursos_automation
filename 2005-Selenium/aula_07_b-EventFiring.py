...
# Class AbstractEventListener: serve para monitorar as ações e eventos no DOM com seus próprios métodos
...
# Criando uma instância do Firefox
browser = Firefox()

# O EventFiringWebDriver serve para monitorar os eventso com o AbstractaEventListener
